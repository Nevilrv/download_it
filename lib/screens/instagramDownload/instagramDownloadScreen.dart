                ...
                _isDisabled
                    ...
                    : MyButton(
                        ...
                        onPressed: () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Fetching Download links...')));
                                      ...
                                      Padding(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          onTap: () async {
                                            ...
                                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Caption Copied')));
                                          },
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: MyButton(
                                          ...
                                          onPressed: () async {
                                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Start Downloading')));
